...
public enum ID3v22FieldKey
{
    ...
    MASTERING(ID3v22Frames.FRAME_ID_V2_UNSYNC_LYRICS, FrameBodyTXXX.MASTERING, Id3FieldType.TEXT),
    MASTERING_SORT(ID3v22Frames.FRAME_ID_V2_UNSYNC_LYRICS, FrameBodyTXXX.MASTERING_SORT, Id3FieldType.TEXT),

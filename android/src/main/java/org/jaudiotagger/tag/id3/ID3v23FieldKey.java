...
public enum ID3v23FieldKey
{
    ...
    MASTERING(ID3v23Frames.FRAME_ID_V3_UNSYNC_LYRICS, FrameBodyTXXX.MASTERING, Id3FieldType.TEXT),
    MASTERING_SORT(ID3v23Frames.FRAME_ID_V3_UNSYNC_LYRICS, FrameBodyTXXX.MASTERING_SORT, Id3FieldType.TEXT),
